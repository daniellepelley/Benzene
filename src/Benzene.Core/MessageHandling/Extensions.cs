...
//     {
//         app.Register(x => DI.Extensions.AddMessageHandlers(x, assemblies));
...
//     {
//         app.Register(x => MessageHandlers.Extensions.AddMessageHandlers(x, types));
//         return app.Use<TContext, MessageRouter<TContext>>();
//     }
//
//     public static IMiddlewarePipelineBuilder<TContext> UseMessageHandlers<TContext>(this IMiddlewarePipelineBuilder<TContext> app,
...
//     {
//         app.Register(x => DI.Extensions.AddMessageHandlers(x, types));
