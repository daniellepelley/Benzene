...
- Failures are a failed `IHealthCheckResult` (never a throw), reporting the exception **type name**,
  never its message - no connection string / entity secret reaches `Data`.
