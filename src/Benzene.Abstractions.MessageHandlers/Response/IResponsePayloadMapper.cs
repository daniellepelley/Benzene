...
/// Used by response handlers such as <c>ResponseBodyHandler{TContext}</c> so the actual serialized
/// payload format stays independent of how the body is written onto the transport context.
/// </summary>
