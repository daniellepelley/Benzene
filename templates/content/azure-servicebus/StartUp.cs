...
public class StartUp : BenzeneStartUp
{
    ...
    // UseServiceBus is a no-op on any host other than Azure Functions, which is what lets this exact
    // StartUp shape be reused across platforms. Each message routes to a handler by its "topic"
    // application property. See docs/azure-functions.md.
    //
