...
namespace Benzene.Examples.Aws.Tests.Integration.Autofac;
...
public class CreateOrderTest : InMemoryOrdersTestBase
{
    ...
    public CreateOrderTest()
        :base(new AutofacTestLambdaStartUp<StartUpAutofac>().Build())
    { }
    ...
    public async Task CreateOrder_ValidationFailure()
    {
        ...
        var response = await TestLambdaHosting.SendBenzeneMessageAsync(benzeneMessageRequest);
