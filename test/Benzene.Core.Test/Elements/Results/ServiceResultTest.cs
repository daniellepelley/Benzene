...
public class BenzeneResultTest
{
    ...
    {
        Assert.Equal(BenzeneResultStatus.UnexpectedError, BenzeneResult.UnexpectedError().Status);
    }

    [Fact]
    public void UnexpectedError_T()
    {
        Assert.Equal(BenzeneResultStatus.UnexpectedError, BenzeneResult.UnexpectedError<Void>().Status);
    }
